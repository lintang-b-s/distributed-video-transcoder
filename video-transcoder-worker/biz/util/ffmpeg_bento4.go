...
func GenerateDASHPlaylistBento(fileName string) error {
	...
	_, err := mp4dash.CombinedOutput()
	if err != nil {
		zap.L().Error(" mp4dash.CombinedOutput() (GenerateDASHPlaylistBento) (util) ", zap.Error(err))
...
func CreateBitrate1080pVideo(filePath string, fileName string) error {
	...
	_, err = mp4fragment1080.CombinedOutput()
	if err != nil {
...
func CreateBitrate720pVideo(filePath string, fileName string) error {
	...
	_, err := ffmpeg720.CombinedOutput()
	if err != nil {
		zap.L().Error(" ffmpeg720.CombinedOutput (CreateBitrate360pVideo) (util) ", zap.Error(err))
		return domain.WrapErrorf(err, domain.ErrInternalServerError, domain.MessageInternalServerError)
	}
	...
	_, err = mp4fragment720.CombinedOutput()
	if err != nil {
		zap.L().Error("mp4fragment720.CombinedOutput (CreateBitrate360pVideo) (util) ", zap.Error(err))
		return domain.WrapErrorf(err, domain.ErrInternalServerError, domain.MessageInternalServerError)
	}
...
func CreateBitrate480pVideo(filePath string, fileName string) error {
	...
	_, err := ffmpeg480.CombinedOutput()
	if err != nil {
		zap.L().Error(" ffmpeg480.CombinedOutput (CreateBitrate360pVideo) (util) ", zap.Error(err))
		return domain.WrapErrorf(err, domain.ErrInternalServerError, domain.MessageInternalServerError)
	}
	...
	_, err = mp4fragment480.CombinedOutput()
	if err != nil {
...
func CreateBitrate360pVideo(filePath string, fileName string) error {
	...
	_, err := ffmpeg360.CombinedOutput()
	if err != nil {
	...
	_, err = mp4fragment360.CombinedOutput()
	if err != nil {
		zap.L().Error(" mp4fragment360.CombinedOutput(CreateBitrate360pVideo) (util) ", zap.Error(err))
		return domain.WrapErrorf(err, domain.ErrInternalServerError, domain.MessageInternalServerError)
	}
